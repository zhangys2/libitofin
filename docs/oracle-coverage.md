...
| Continuous geometric Asian | `AnalyticContinuousGeometricAveragePriceAsianEngine` | `asianoptions.cpp` `testAnalyticContinuousGeometricAveragePrice` | Haug put NPV 4.6922 @ 1e-4 (S=80, K=85, 90d) |
