...
| Dedicated QuantoVanillaOption | `QuantoVanillaOption` (`QuantoOptionResults`) | `quantooption.cpp` `testValues` / `testGreeks` | Dedicated instrument with typed quanto greeks (`qvega`, `qrho`, `qlambda`); Haug values @ 1e-4; expired zeroes @ 1e-12 |
