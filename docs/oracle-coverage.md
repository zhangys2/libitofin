...
| Variance swap (replicating) | `VarianceSwap` + `ReplicatingVarianceSwapEngine` | `varianceswap.cpp` `testReplicatingVarianceSwap` | Derman–Kamal–Zou 1999 fair variance 0.04189 @ 1e-4; MC / variance option deferred |
