...
| Swaption Black implied vol | `Swaption::implied_volatility` | `swaption.cpp` `testImpliedVolatility` | Spot Physical Black ShiftedLognormal grid @ 1e-8; Cash/Forward/OIS/Bachelier deferred |
...
| Two-asset barrier Haug NPV | `AnalyticTwoAssetBarrierEngine` | `twoassetbarrieroption.cpp` `testHaugValues` | Heynen–Kat 4-row table @ 4e-3 |
