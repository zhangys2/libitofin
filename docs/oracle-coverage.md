...
| Swaption Black implied vol | `Swaption::implied_volatility` | `swaption.cpp` `testImpliedVolatility` | Spot Physical Black + reduced Spot Cash/`ParYieldCurve` @ 1e-8; reduced Spot Physical Normal; Forward/OIS deferred |
