...
| Analytic quanto forward | `QuantoForwardEuropeanEngine` (`QuantoEngine<ForwardVanillaOption, ForwardVanillaEngine<AnalyticEuropeanEngine>>`) | `quantooption.cpp` `testForwardValues` | reset=0 ≡ quanto vanilla; reset=0.25 FinCAD call 2.0171 / put 6.7296 @ 1e-4 |
