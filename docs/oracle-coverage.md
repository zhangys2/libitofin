...
| Analytic performance cliquet | `AnalyticPerformanceEngine` | `cliquetoption.cpp` `testPerformanceGreeks` | δ=γ=0; NPV independent of spot; ρ/divρ/ν vs FD @ 1e-5 relative to spot |
