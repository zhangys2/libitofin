...
| European Margrabe exchange Greeks | `MargrabeOption`, `AnalyticEuropeanMargrabeEngine` | `margrabeoption.cpp` `testEuroExchangeTwoAssets` / `testGreeks` | 21-row European table for NPV and 6 greeks @ 1e-3; testGreeks FD bump consistency; instrument setup_expired zeros greeks; American engine deferred |
