...
| FdG2SwaptionEngine (Douglas) | `FdG2SwaptionEngine` | `fdg2swaptionengine` | ITM European>0; ≈ analytic G2 @ 1.5; Bermudan≥European |
...
|--------|-------------------|----------|
| G2 tree / Hundsdorfer FdG2 oracle | `TwoFactorModel::tree`; Hundsdorfer ADI for `testCachedG2Values` | P2 |
