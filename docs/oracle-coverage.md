...
| FD Heston American quanto | `FdHestonVanillaEngine` American + cash div + quanto | `quantooption.cpp` `testAmericanQuantoOption` | near-Black Heston (`σ=1e-4`) cached 8.90611734 @ 1e-4 |
