...
| Discrete geometric Asian | `AnalyticDiscreteGeometricAveragePriceAsianEngine` / `MCDiscreteGeometricAveragePriceAsianEngine` | `asianoptions.cpp` `testAnalyticDiscreteGeometricAveragePrice` / `testAnalyticDiscreteGeometricAveragePriceGreeks` / `testMCDiscreteGeometricAveragePrice` | Levy call NPV 5.3425606635 @ 1e-10; δ/γ/θ/ρ/divρ/ν vs FD @ 1e-5; MC vs analytic @ 4e-3 (8191 samples) |
