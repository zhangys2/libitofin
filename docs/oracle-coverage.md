...
| Discrete arithmetic Asian | `MCDiscreteArithmeticAveragePriceAsianEngine` / `MCDiscreteArithmeticAveragePriceAsianHestonEngine` | `asianoptions.cpp` `testMCDiscreteArithmeticAveragePrice` / `testMCDiscreteArithmeticAveragePriceHeston` | Levy (1997) 30-row put table @ 2e-2 (`LowDiscrepancy`, 2047 samples, geometric CV); Ballestra call @ 5e-2 (4095 samples) / Albrecher–Zeng calls @ 9e-2 (16383 samples, QL uses 8191; seed 42; Heston CV deferred) |
