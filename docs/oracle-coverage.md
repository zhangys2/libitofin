...
| MakeVanillaSwap stub dates | `with_*_leg_first_date` / `with_*_leg_next_to_last_date` | `makevanillaswap.cpp:146/153` + Schedule stub pins | float first 31-Mar-2018 irregular; next-to-last 15-Mar-2024 irregular; matches hand-built `Schedule` |
