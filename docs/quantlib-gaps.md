...
| Rates | Cap/floor Black extras | `CapFloor`, Black engine | `capfloor.cpp` (ATM, parity) | true | partial | Cached NPV/vega + δ + `impliedVolatility` + `optionlet(i)` recomposition pinned; ATM/parity suite already covered |
