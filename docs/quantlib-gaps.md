...
| Equity | Two-asset correlation | `TwoAssetCorrelationOption` | `twoassetcorrelationoption.cpp` | true | partial | Analytic Haug NPV @ 1e-4 (`testAnalyticEngine`) closed. American / other oracles deferred |
