...
| Rates | Cap/floor Black extras | `CapFloor`, Black engine | `capfloor.cpp` (implied vol, Bachelier δ, ATM, parity) | true | partial | Cached NPV/vega + `optionletsDelta` FD pinned; implied vol / Bachelier δ / `optionlet(i)` open |
