...
| Equity | Binary / double-binary barrier | `AnalyticBinaryBarrierEngine`, `AnalyticDoubleBarrierBinaryEngine` | `binaryoption.cpp`, `doublebarrieroption.cpp` | true | partial | `AnalyticBinaryBarrierEngine` Haug p.180 cash/asset-or-nothing closed; double-binary deferred |
