...
| Rates | Swaption Black extras | `Swaption`, `BlackSwaptionEngine` | `swaption.cpp` (Cash*) | true | partial | Cached NPV/vega/cash-settled + Spot/Forward Physical Black + reduced Spot Physical OIS + reduced Normal `impliedVolatility` pinned; remaining: Cash settlement arm |
