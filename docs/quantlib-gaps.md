...
| Equity | Margrabe / exchange | `MargrabeOption` | `margrabeoption.cpp` | true | partial | European NPV + extra Greeks (delta1, delta2, gamma1, gamma2, theta, rho) vs Haug / QL 21-row table @ 1e-3 + reduced moving-market FD check closed. Still open: American engine, full testGreeks sweep |
