...
| Rates | Bermudan OIS swaption (HW/G2) | OIS-underlying `Swaption` | `bermudanswaption.cpp` OIS cases | true | partial | HW + G2 FDM OIS Bermudan pinned (+ HW Simple/Compound feature pin); lockout deferred |
