...
| Rates | Black–Karasinski | `blackkarasinski.hpp` | `blackkarasinski.cpp` (no suite; identity) | partial | partial | Model + `BlackKarasinskiDynamics` log transform; `tree()` / Brent fit deferred |
