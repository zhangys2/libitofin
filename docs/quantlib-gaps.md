...
| Equity | Asset-or-nothing / gap / super payoffs | `AssetOrNothing`, `Gap`, `Super*` | `binaryoption.cpp` | true | partial | Asset-or-nothing European Haug p.90 closed; gap/super open |
