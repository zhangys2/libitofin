...
| Rates | Bermudan OIS swaption (HW/G2) | OIS-underlying `Swaption` | `bermudanswaption.cpp` OIS cases | true | partial | HW FDM `testBermudanOISSwaptionWithHW` pinned; G2 + averaging/lockout feature pins deferred |
