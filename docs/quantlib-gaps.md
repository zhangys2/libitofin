...
| Rates | Swaption Black extras | `Swaption`, `BlackSwaptionEngine` | `swaption.cpp` (Cash/Forward/OIS*) | true | partial | Cached NPV/vega/cash-settled + Spot Physical Black + reduced Normal `impliedVolatility` pinned; remaining: Cash / Forward / OIS arms |
