...
mod tests {
    ...
    /// `fdheston.cpp` `testFdmHestonBarrierVsBlackScholes`: Haug p.72 table,
    /// near-Black Heston FD 200×101×3 vs `AnalyticBarrierEngine` @ 0.25% relative.
    #[test]
    fn fdm_heston_barrier_vs_black_scholes() {
        ...
        // barrier, type, strike, q, r, t, v — rebate 3, spot 100 as in Haug p.72.
        let rows = [
            (
                BarrierType::DownOut,
                95.0,
