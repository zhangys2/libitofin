...
mod tests {
    ...
    use crate::instruments::{BarrierOption, PlainVanillaPayoff, set_analytic_barrier_engine};
    ...
    /// `fdheston.cpp` `testFdmHestonBarrierVsBlackScholes`: QL `values[]`
    /// (Haug p.72 layout) near-Black Heston FD 200×101×3 vs
    /// `AnalyticBarrierEngine` @ 0.25% relative.
    #[test]
    fn fdm_heston_barrier_vs_black_scholes() {
        let today = Date::new(28, Month::March, 2004);
        let settings = shared(Settings::new());
        settings.set_evaluation_date(today);
        let dc = Actual365Fixed::new();
        ...
        let vol_ts = Handle::new(
            shared(BlackConstantVol::with_quote(today, None, qh(&vol), dc))
        ...
        // barrierType, barrier, type, strike, q, r, t, v — rebate 3, spot 100
        // (QL NewBarrierOptionData minus rebate/s).
        type FdHestonHaugRow = (BarrierType, Real, OptionType, Real, Real, Real, Real, Real);
        #[rustfmt::skip]
        const FDM_HESTON_BARRIER_VS_BS: &[FdHestonHaugRow] = &[
            (BarrierType::DownOut,   95.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownOut,   95.0, OptionType::Call,100.0, 0.00, 0.08, 1.00, 0.30),
            (BarrierType::DownOut,   95.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownOut,  100.0, OptionType::Call, 90.0, 0.00, 0.08, 0.25, 0.25),
            (BarrierType::DownOut,  100.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownOut,  100.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpOut,    105.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpOut,    105.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpOut,    105.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,    95.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,    95.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,    95.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,   100.0, OptionType::Call, 90.0, 0.00, 0.08, 0.25, 0.25),
            (BarrierType::DownIn,   100.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,   100.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpIn,     105.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpIn,     105.0, OptionType::Call,100.0, 0.00, 0.08, 0.40, 0.25),
            (BarrierType::UpIn,     105.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.15),
            (BarrierType::DownOut,   95.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,   95.0, OptionType::Call,100.0, 0.00, 0.08, 0.40, 0.35),
            (BarrierType::DownOut,   95.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,  100.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.15),
            (BarrierType::DownOut,  100.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,  100.0, OptionType::Call,110.0, 0.00, 0.00, 1.00, 0.20),
            (BarrierType::UpOut,    105.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpOut,    105.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpOut,    105.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,    95.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,    95.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,    95.0, OptionType::Call,110.0, 0.00, 0.08, 1.00, 0.30),
            (BarrierType::DownIn,   100.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,   100.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,   100.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpIn,     105.0, OptionType::Call, 90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpIn,     105.0, OptionType::Call,100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpIn,     105.0, OptionType::Call,110.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,   95.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownOut,   95.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownOut,   95.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownOut,  100.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownOut,  100.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownOut,  100.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpOut,    105.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpOut,    105.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpOut,    105.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,    95.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,    95.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,    95.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,   100.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,   100.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::DownIn,   100.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpIn,     105.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpIn,     105.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.25),
            (BarrierType::UpIn,     105.0, OptionType::Put, 110.0, 0.00, 0.04, 1.00, 0.15),
            (BarrierType::DownOut,   95.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,   95.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,   95.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,  100.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,  100.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownOut,  100.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpOut,    105.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpOut,    105.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpOut,    105.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,    95.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,    95.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,    95.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,   100.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,   100.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::DownIn,   100.0, OptionType::Put, 110.0, 0.04, 0.08, 1.00, 0.15),
            (BarrierType::UpIn,     105.0, OptionType::Put,  90.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpIn,     105.0, OptionType::Put, 100.0, 0.04, 0.08, 0.50, 0.30),
            (BarrierType::UpIn,     105.0, OptionType::Put, 110.0, 0.04, 0.08, 0.50, 0.30),
        ];
        const TOL: Real = 0.0025;
        const REBATE: Real = 3.0;
        const S: Real = 100.0;

        for (i, (barrier_type, barrier, option_type, strike, q, r, t, v)) in
            FDM_HESTON_BARRIER_VS_BS.iter().copied().enumerate()
        {
            spot.set_value(S);
            q_rate.set_value(q);
            r_rate.set_value(r);
            vol.set_value(v);
            let ex_date = today + (t * 365.0_f64).round() as i32;
            let exercise: Shared<dyn Exercise> = shared(EuropeanExercise::new(ex_date));
            ...
            let calculated = option.npv().unwrap();
            set_analytic_barrier_engine(&mut option, Shared::clone(&bs_process));
            let expected = option.npv().unwrap();
            let rel = (calculated - expected).abs() / expected;
            assert!(
                rel <= TOL,
                "row {i} {barrier_type:?} {option_type:?} K={strike} H={barrier} \
                 q={q} r={r} t={t} v={v}: FD {calculated} vs analytic {expected} \
                 (relative {rel})"
            );
        }
    }
