//! Swap exercise payoff on a G2++ factor grid.
//!
//! Port of QuantLib's `FdmAffineModelSwapInnerValue<G2>`
...
//! ## Scope
//!
//! G2 / vanilla Ibor swaps only. Hull–White `getState` and the Overnight-index
//! rebuild branch are deferred.
//!
//! ## Divergences from QuantLib
//!
//! - Concrete G2 type rather than a C++ class template.
...
use crate::models::shortrate::{AffineModel, G2};
